...
# Example usage
folder_path = "C:/Users/deniskirbaba/Desktop/summarized_dataset/dataset/img_temp"  # Replace with the path to your folder
postfix = "_5"  # Replace with your desired postfix
